...
|----------|------|-------------|-----------|
| 🔴 P0 | **Notifications BC Phase 1** — Transactional emails for all 7 return lifecycle events | PO | Currently missing. Customers have no email notifications for returns. |
