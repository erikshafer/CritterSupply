...
label "bc:backoffice-identity"  "6a4ebd"  "Backoffice Identity bounded context"
label "bc:admin-portal"         "7057ff"  "Legacy alias for bc:backoffice (do not use for new issues)"
label "bc:correspondence"       "b794f4"  "Correspondence bounded context (renamed from Notifications, ADR 0030)"
