...
builder.Host.UseWolverine(opts =>
{
    ...
    // Discover handlers from the AdminIdentity domain assembly
    opts.Discovery.IncludeAssembly(typeof(AdminUser).Assembly);
...
if (app.Environment.IsDevelopment())
{
    ...
    var dbContext = scope.ServiceProvider.GetRequiredService<AdminIdentityDbContext>();
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(opts =>
    {
        ...
        opts.SwaggerEndpoint("/api/v1/swagger.json", "Admin Identity API");
    });
}
